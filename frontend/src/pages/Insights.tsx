  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 max-w-7xl mx-auto pb-12">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">Career Insights</h1>
      ...
      {error && (
        <div className="p-4 bg-rose-50 border border-rose-200 rounded-xl text-rose-600 text-sm font-medium flex items-center justify-between">
          <span>⚠️ {error} (Showing mock data instead)</span>
          <Button variant="outline" size="sm" className="bg-white border-rose-200 text-rose-600 hover:bg-rose-50" onClick={() => fetchOpportunities(activeTab)}>Retry</Button>
        </div>
      )}
