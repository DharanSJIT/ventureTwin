...
import { Bot, Mail, Lock, ArrowRight, HeartHandshake } from 'lucide-react';
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error(data.message || "We couldn't log you in. Double check your details?");
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 selection:bg-blue-100 selection:text-primary font-sans overflow-hidden">
      <motion.div 
        ...
        className="w-full max-w-[1000px] bg-white rounded-[32px] shadow-2xl shadow-blue-900/10 overflow-hidden flex flex-col md:flex-row"
      >
        {/* Left Side - Humanized Branding */}
        <div className="md:w-5/12 bg-primary p-12 text-white flex flex-col justify-between hidden md:flex relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            >
              Hey there! <br/> Let's get you back in. 👋
            </motion.h2>
            <motion.p 
              initial={{ y: 20, opacity: 0 }} 
              animate={{ y: 0, opacity: 1 }} 
            ...
            >
              Your Digital Twin has been learning while you were away. We've got fresh insights waiting for you.
            </motion.p>
          </div>
          ...
          >
            ...
            We keep your personal data strictly private and secure.
          </motion.div>
        </div>

        {/* Right Side - Humanized Form */}
        <div className="md:w-7/12 p-8 md:p-14 lg:p-16 flex flex-col justify-center bg-white relative z-20">
          ...
          >
            ...
            <motion.h3 variants={itemVariants} className="text-3xl font-extrabold text-slate-900 mb-2 tracking-tight">Welcome back!</motion.h3>
            <motion.p variants={itemVariants} className="text-slate-500 mb-10 text-base">We're so glad to see you again. Drop your details below to jump right back in.</motion.p>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <motion.div variants={itemVariants} className="space-y-2 group">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <motion.a whileHover={{ scale: 1.05 }} href="#" className="text-xs font-semibold text-primary hover:text-blue-700 transition-colors">Forgot it?</motion.a>
                </div>
                <div className="relative">
            ...
            <motion.div variants={itemVariants} className="mt-10 flex flex-col items-center">
              <div className="relative flex py-6 items-center w-full">
                ...
                <span className="flex-shrink-0 mx-4 text-slate-400 text-sm font-medium">New around here?</span>
                <div className="flex-grow border-t border-slate-100"></div>
              </div>
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full">
                <Button variant="outline" className="w-full h-12 border-slate-200 text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition-colors rounded-xl font-semibold text-base shadow-sm" onClick={() => navigate('/register')}>
