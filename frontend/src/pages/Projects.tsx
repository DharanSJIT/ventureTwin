      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {user?.projects && user.projects.length > 0 ? (
          user.projects.map((project, index) => (
            <Card key={index} className="border-slate-200 shadow-sm hover:shadow-md transition-shadow group cursor-pointer">
          ...
          <div className="col-span-full py-12 text-center bg-slate-50 border border-slate-200 border-dashed rounded-xl">
            ...
            <p className="text-slate-500 mb-4">Upload your resume to automatically extract your projects!</p>
          </div>
        )}
      </div>
    </div>
